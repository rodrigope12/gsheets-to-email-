# 📧 GSheets Email Automation



## 🚀 Overview
Automated mail merge and notification system driven directly by Google Sheets triggers.
...
## 🛠️ Technology Stack
*   **Core**: Google Sheets, Email Automation, Google Apps Script
*   **Infrastructure**: Git, Local Environment

## 📦 Installation & Setup
```bash
# Clone the repository
git clone https://github.com/rodrigope12/gsheets-to-email-.git
